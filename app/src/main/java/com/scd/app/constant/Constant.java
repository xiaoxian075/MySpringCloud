...
public class Constant {
	...
	public static <T extends BaseAcceptMsg> T subNoPack(HttpServletRequest request, Class<T> c) {
		return Encrypt.getInstance().subNoPack(request, c);
	}
	...
	public static <T> String noPack(T t) {
