...
import com.scd.app.hystrix.HAccount;
...
//	@RequestMapping(value = "/account/total")
//	Return<MemberPo> getTotal(@RequestParam(value = "account") String account);

	@RequestMapping(value = "/account/getMember")
	Return<MemberPo> getMember(@RequestParam(value = "account")String account);
}
